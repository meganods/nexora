...
import '../widgets/top_rated_professionals_section.dart';
...
import '../widgets/refer_earn_section.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const SearchScreen(startVoice: true),
                        ),
                      );
                    },
                    child: const Icon(
  ...
  Widget _buildCategoryGrid() {
    final int totalCount = DummyData.allCategories.length;
    final int mainGridCount = 7;
    final int remainingCount = totalCount > mainGridCount ? (totalCount - mainGridCount) : 0;
    final String moreLabel = remainingCount > 0 ? "$remainingCount+ More" : "Explore All";
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        ...
                        _topMenuCard(
                          context,
                          "Electrical",
                          "assets/images/categories/electrician_icon_1774853479339.png",
                        ),
                        _topMenuCard(
                          context,
                          "Carpenter",
