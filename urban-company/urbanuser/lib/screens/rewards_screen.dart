          ...
          builder: (context, snapshot) {
            ...
            for (var doc in docs) {
              ...
              activeCoupons.add({
                "id": doc.id,
                "code": code,
                "title": data['title'] ?? "Platform Voucher",
                "desc": data['description'] ?? "Special discount code.",
                "expiry": endDate != null ? "Expires ${endDate.day}/${endDate.month}" : "No Expiry",
                "color": doc.id.hashCode % 2 == 0 ? const Color(0xFF673AB7) : const Color(0xFF00BFA5),
            ...
            if (activeCoupons.isEmpty) {
              return Padding(
                ...
                child: Text(
                  "No active rewards or coupons available to claim.",
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    final reward = activeCoupons[index];
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => OfferDetailsScreen(couponId: reward["id"] as String),
                          ),
                        );
                      },
                      child: _rewardCard(
