...
class _ReviewDetailsScreenState extends State<ReviewDetailsScreen> {
  ...
  Future<void> _submitToFirebase() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('vendors').doc(user.uid).set(dataToSave, SetOptions(merge: true));
      if (user.email != null && user.email!.isNotEmpty && user.email != user.uid) {
        await FirebaseFirestore.instance.collection('vendors').doc(user.email).set(dataToSave, SetOptions(merge: true));
      }
